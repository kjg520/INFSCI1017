...
public class MySqlUtilities implements DbUtilities{
    ...
    private String dbName = "kjg46_bank1017"; // default database name
    private String dbUserName = "kjg46"; // login name for the database server
    private String dbPassword = "3916669"; // password for the database server
    ...
    /**
     * This method closes open database connections after other classes have ran database queries
     */
